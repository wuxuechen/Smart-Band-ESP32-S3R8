...
void create_screen_activity_rank() {
    ...
    lv_obj_set_style_text_font(obj, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            // activity_rank_tabel
            lv_obj_t *obj = lv_img_create(parent_obj);
            objects.activity_rank_tabel = obj;
            lv_obj_set_pos(obj, 0, 40);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_tabel);
        }
        {
            // activity_rank_name_0
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_0 = obj;
            lv_obj_set_pos(obj, 0, 64);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "Joseph");
        }
        {
            // activity_rank_name_1
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_1 = obj;
            lv_obj_set_pos(obj, 0, 88);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_2
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_2 = obj;
            lv_obj_set_pos(obj, 0, 112);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_3
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_3 = obj;
            lv_obj_set_pos(obj, 0, 136);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_4
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_4 = obj;
            lv_obj_set_pos(obj, 0, 160);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_5
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_5 = obj;
            lv_obj_set_pos(obj, 0, 184);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_6
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_6 = obj;
            lv_obj_set_pos(obj, 0, 208);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_7
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_7 = obj;
            lv_obj_set_pos(obj, 0, 232);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_name_8
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_name_8 = obj;
        ...
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.obj11 = obj;
            lv_obj_set_pos(obj, 161, 40);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "Steps");
        }
        {
            // activity_rank_steps_0
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_0 = obj;
            lv_obj_set_pos(obj, 161, 64);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "78910");
        }
        {
            // activity_rank_steps_1
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_1 = obj;
            lv_obj_set_pos(obj, 161, 88);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_2
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_2 = obj;
            lv_obj_set_pos(obj, 161, 112);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_3
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_3 = obj;
            lv_obj_set_pos(obj, 161, 136);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_4
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_4 = obj;
            lv_obj_set_pos(obj, 161, 160);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_5
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_5 = obj;
            lv_obj_set_pos(obj, 161, 184);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_6
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_6 = obj;
            lv_obj_set_pos(obj, 161, 208);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_7
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_7 = obj;
            lv_obj_set_pos(obj, 161, 232);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
        {
            // activity_rank_steps_8
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.activity_rank_steps_8 = obj;
            lv_obj_set_pos(obj, 161, 256);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_label_set_text(obj, "");
        }
    }
...
void create_screen_ota() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0f0552), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            objects.ota_update_percent = obj;
        ...
        {
            // ota_update_percent_label
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.ota_update_percent_label = obj;
            lv_obj_set_pos(obj, 97, 108);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
